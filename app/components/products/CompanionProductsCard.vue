...
<template>
  <div v-if="view === 'lists'">
    <div
      class="z-5 relative my-7 h-full rounded-3xl border border-gray-300 bg-white px-3 py-6 hover:border-gray-50 hover:shadow-2xl"
    >
      <div class="flex h-full flex-row items-start justify-between">
        ...
        <div v-if="cardImage" class="aspect-square relative z-1 mb-2">
          ...
          <div
            :to="productLink"
            class="'flex overflow-hidden' h-[116px] w-[135px] items-center justify-center"
          >
            <img
              :srcset="cardImage"
              class="lazyload lazyload-fade aspect-auto relative inset-0 block h-full w-full rounded-[15px] object-cover"
              width="400"
              height="400"
              loading="lazy"
            />
        ...
        <div class="ml-3 flex w-full flex-row items-center justify-center">
          <div>
            <!-- Product Info -->
            <div class="mb-2">
              <NuxtLink :to="productLink">
                <div
                  class="text-[12px] font-semibold leading-[15.6px] tracking-normal text-text-gray"
                  v-html="primaryText"
                />
                <p
                  class="text-[12px] font-normal leading-[15.6px] tracking-normal text-text-grey"
            ...
            <div>
              <NuxtLink :to="productLink">
                <p
                  class="text-[12px] font-normal leading-[15.6px] tracking-normal text-text-grey"
                  v-html="truncate(productDescription, 60)"
                />
              </NuxtLink>
            </div>
            <div class="mt-2">
