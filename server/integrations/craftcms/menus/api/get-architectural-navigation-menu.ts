...
const navHandle = 'architecturalNavigation'

export async function getArchitecturalNavigationMenu(context: ApiContext = {}) {
  try {
    ...
    logError(getArchitecturalNavigationMenu.name, error)
    throw error
  }
}
