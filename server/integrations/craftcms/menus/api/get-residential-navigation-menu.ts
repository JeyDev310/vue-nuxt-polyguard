...
const navHandle = 'residentialNavigation'

export async function getResidentialNavigationMenu(context: ApiContext = {}) {
  try {
    ...
    logError(getResidentialNavigationMenu.name, error)
    throw error
  }
}
