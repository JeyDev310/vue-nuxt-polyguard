...
const navHandle = 'mechanicalNavigation'

export async function getMechanicalNavigationMenu(context: ApiContext = {}) {
  try {
    ...
    logError(getMechanicalNavigationMenu.name, error)
    throw error
  }
}
